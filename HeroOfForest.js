	...
	switch (input) {
		...
		case commands[42]:
			if (storyInv[0]==1 && paperCount==paperMax && locationNum==24) {
				document.getElementById("locainfo").innerHTML = "You return the book of your memories to their rightful place, and the book flies open. Pages begin flipping one after another, turing to golden dust and swirling around you. Once they've all turned to dust, the book slams shut and the dust glows brightly before disappearing.";
			} else {
				alert("I can't do that");
			}
		break;
