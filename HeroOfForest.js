...
function infoChange() {
	...
	switch (input) {
		...
		break;
		case commands[41]:
			if (itemInv[9]==2 && locationNum==6) {
				if (itemInv[10]==1 && storyInv[1]==2) {
					itemInv[10]=2;
				...
				} else if (itemInv[10]!==1 && storyInv[1]==2) {
					document.getElementById("locainfo").innerHTML = "I don't have a bobby pin to do that with.";
				} else if (itemInv[10]==1 && storyInv[1]!==2) {
		...
		case commands[42]:
			if (storyInv[0]==1 && paperCount==paperMax && locationNum==24) {
				document.getElementById("locainfo").innerHTML = "You return the book of your memories to their rightful place, and the book flies open. Pages begin flipping one after another, turing to golden dust and swirling around you. Once they've all turned to dust, the book slams shut and the dust glows brightly before disappearing. CONGRATS, YOU DID IT!!! (credit to Kevin Silveira for maps)";
